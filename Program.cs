...
class Program
{
    ...
    static void SearchClientsByProduct(string productName, IXLWorksheet wsProducts, IXLWorksheet wsOrders, IXLWorksheet wsClients)
    {
    ...
    static void ChangeContactPerson(string companyName, string newContactPerson, IXLWorksheet wsClients)
    {
    ...
    static void FindGoldenClient(int year, int month, IXLWorksheet wsOrders, IXLWorksheet wsClients)
    {
